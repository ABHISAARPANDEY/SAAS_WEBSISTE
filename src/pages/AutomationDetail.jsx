          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center">
              ...
              <motion.button
                ...
                className="bg-white text-accent-primary border border-accent-primary px-6 sm:px-8 py-3 sm:py-4 rounded-full font-medium text-base sm:text-lg hover:bg-accent-primary/5 transition-all duration-300 w-full sm:w-auto"
              >
